...
if(isset($_POST['submit']))
{
	...
	$sql="update `contactus` set name=$name,phone=$phone,gender=$gender,district=$district";
...
<label>Mobile Number</label><input type = "text" name = "phone" value=<?php echo $phone;?>><br>
<label>District</label><select name = "district" value=<?php echo $district;?>><option>--select--</option><option>Dindigul</option><option>Trichy</option></select>
